...
urlpatterns = [
		...
		# url(r'^posts/<int:pk>/', PostDetailView.as_view(), name='post-detail'),
		url(r'^posts/(?P<pk>\d+)/$', PostDetailView.as_view(), name='post-detail'),
		url(r'^posts/new', PostCreateView.as_view(), name='post-create'),

	    # url(r'^posts/<int:pk>/edit/', PostUpdateView.as_view(), name='post-update'),
		url(r'^posts/(?P<pk>\d+)/edit/', PostUpdateView.as_view(), name='post-update'),

		#url(r'^posts/<int:pk>/delete/', PostDeleteView.as_view(), name='post-delete'),
